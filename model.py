...
class GCNModelAE(Model):
    ...
    def _build(self):
        ...
        self.cluster_layer = ClusteringLayer(input_dim=FLAGS.hidden2, n_clusters=FLAGS.n_clusters, name='clustering')
        ...
        self.rec = GraphConvolution(input_dim=FLAGS.hidden2,
                                                 ...
                                                 dropout=self.dropout,
                                                 logging=self.logging)(self.embeddings)
        self.reconstructions2 = GraphConvolution(input_dim=FLAGS.hidden1,
                                                output_dim=1024,
                                                adj=self.adj,
                                                act=lambda x: x,
                                                dropout=self.dropout,
